...
class IncomeAction extends BaseAction
{
	public function cash_list($_action_access=0){
        ...
        $search_items = array(
        	array('name'=>'account','placeholder'=>'请输入会员ID、账号、昵称','cls'=>'w250','_parser'=>'form_item/search/input'),      
        	array('name'=>'time','label'=>'提现记录时间','_parser'=>'form_item/search/date'),  
        	array('name'=>'flag','_parser'=>'form_item/search/select','data'=>array(''=>'记录类型','1'=>'待处理','2'=>'已处理','3'=>'已退回'),'style'=>'width:120px;'),
            ...
            $form_items = array(
                ...
                array('_parser'=>'tab/default','_children'=>array(
                    array('label'=>'基本信息','_parser'=>'container/default','_children'=>array(
                        array('name'=>'flag','label'=>'状态：','_parser'=>'form_item/collect/radio','data'=>array('1'=>'待处理','2'=>'已处理','3'=>'已退回'),),
    ...
    public function income_list($_action_access=0){
		...
		foreach($list_items as $v){
			...
			if($arrival_fee && $wealth_fee && $service_fee){
        ...
        int_to_string($list_items,array(
        	'type'=>array('1'=>'用户消费','2'=>'用户提现','3'=>'商家提现'),
        ));
        ...
        $search_items = array(
        	...
        	array('name'=>'type','_parser'=>'form_item/search/select','data'=>array(''=>'记录类型','1'=>'用户消费','2'=>'用户提现','3'=>'商家提现'),'style'=>'width:120px;'),
        ...
        $table_headers = array(
            ...
            array('name'=>'arrival_fee','cls'=>'w110','title'=>'商家红包池入账金额'),
