...
//定义WebService配置路径(网络绝对路径)
define("SYS_WEB_SERVIC_TEMP","http://192.168.2.20"."/".SYS_EN_NAME."/index.php/Webservice/");		
...
?>
<form id="form1" name="form1" method="post"  action="<?php echo SYS_WEB_SERVIC_TEMP.MODEL_METHORD?>" enctype="multipart/form-data">
...
<?php echo("<br>当前测试方法名为： ".SYS_WEB_SERVIC_TEMP.MODEL_METHORD);?> &nbsp;&nbsp;<input type="submit" name="submit" id="submit" value="提交" />
</form>
</body>
</html>