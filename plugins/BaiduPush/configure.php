...
class BAIDU_PUSH_CONFIG {
    ...
    //安卓API Key
    const android_apiKey = 'ck4XqFkxVXpVRLskGhoCYe7D';
    //安卓Secret Key
    const android_secretkey = '3ci3M0PbIPV4qxYgN3unAIenQspPjnBv';

    //苹果API Key
    const iphone_apiKey = 'LcmdgqG6lGRykVy1Mn6zqnQd';
    //苹果Secret Key
    const iphone_secretkey = 'ZaY1zCSff5yj2EoW4GsSdlEk4v42WZfT';
