<div class="container-fluid">
    <div class="ml-20 pt-20">
        <form class="form form-inline" action="<?=U('Teacher/teacher_temp_file_load')?>">
            <span class="mr-20">
    ...
    <div class="cl bg-1 bk-gray mt-20 ml-20 pd-5">
        <span class="f-l mr-5">
            <a class="btn btn-primary radius" href="javascript:;" id="import-start" url="<?=U('Teacher/teacher_by_one_import')?>">开始导入</a>
        </span>
        <span class="f-l mr-5">
        ...
        <span class="f-l mr-5">
            <a class="btn btn-primary radius" href="javascript:;" id="export-fail" url="<?=U('Teacher/teacher_fail_export')?>">导出全部失败数据</a>
        </span>
    ...
    <div class="mt-10 ml-20" style="height:400px;overflow-y: auto;">
        <table class="table table-border table-bordered table-hover">
            ...
            <tr>
                ...
                <th class="text-c">生日</th>
                <th class="text-c">职称</th>
                <th class="text-c">任教科目</th>
                <th class="text-c w80">任课班级</th>
                <th class="text-c">学历</th>
                <th class="text-c">专业</th>
